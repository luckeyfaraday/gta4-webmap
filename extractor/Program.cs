...
static string TextureName(ShaderFx shader)
{
...
static Texture FindTexture(TextureFile file, string name)
{
...
static string CanonicalTextureName(string name)
{
...
static void WriteDds(string path, Texture texture)
{
...
static void WritePng(string path, Texture texture)
{
...
static void WritePngChunk(Stream output, string type, byte[] data)
{
